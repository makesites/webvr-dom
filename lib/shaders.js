...
Shaders.prototype.draw = function( source ){
	...
	// Initialize Programs
	this.position = initPosition(gl);
	this.distortion = initDistortion(gl);
...
// Initialize Position
Shaders.prototype.initPosition = function(gl){
...
Shaders.prototype.initDistortion = function(){
	...
	// Create Program
	var vs = getContentsFromFile("../shaders/distortion.vs");
	var fs = getContentsFromFile("../shaders/distortion.fs");
...
Shaders.prototype.getContentsFromFile = function(url){
	return $.ajax({
		type		: "GET",
		url			: url,
		dataType	: "text",
